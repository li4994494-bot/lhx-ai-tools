            ...
            <motion.div key="completed" className="space-y-6">
              <div className="flex items-center justify-between px-4">
                ...
                <button 
                  ...
                  className="flex items-center gap-2 bg-[#4285F4] text-white font-bold px-6 py-3 rounded-2xl hover:brightness-110 active:scale-95 transition-all shadow-lg shadow-blue-50/10"
                >
                  <Copy size={18} /> 一键复制
                </button>
              </div>
